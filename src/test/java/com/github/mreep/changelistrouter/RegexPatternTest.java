...
public class RegexPatternTest
{
    ...
    public void matchesRelativePathWithExtension()
    {
        ...
        assertEquals("XML Files", ChangelistRouterListener.findMatchingChangelist("testowy/pliczek.xml", mappings));
    }
    ...
    public void matchesAllFilesUnderDirectory()
    {
        ...
        assertNull(ChangelistRouterListener.findMatchingChangelist("test/Main.java", mappings));
    }
    ...
    public void matchesHiddenFiles()
    {
        ...
        assertEquals("Hidden Files", ChangelistRouterListener.findMatchingChangelist(".gitignore", mappings));
        assertEquals("Hidden Files", ChangelistRouterListener.findMatchingChangelist(".login", mappings));
        assertNull(ChangelistRouterListener.findMatchingChangelist("visible.txt", mappings));
    }
